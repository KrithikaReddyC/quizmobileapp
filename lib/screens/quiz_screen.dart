      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            if (_answered) Text(_feedbackText, style: TextStyle(fontSize: 16, color: _selectedAnswer == question.correctAnswer ? Colors.green : Colors.red)),
            if (_answered) ElevatedButton(onPressed: _nextQuestion, child: Text('Next Question')),
          ],
        ),
      ),
    );
